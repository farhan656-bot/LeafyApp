...
interface CareHistoryDao {
    ...
    fun getHistoryByPlantId(plantId: Int): Flow<List<CareHistory>>
    ...
    @Query("DELETE FROM care_history WHERE plantId = :plantId")
    suspend fun deleteHistoryByPlantId(plantId: Int)
}